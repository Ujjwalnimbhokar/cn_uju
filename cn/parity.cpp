...
// 1
// Explanation:
// The program calculates the number of redundant bits required, inserts them, and calculates their values to create the Hamming Code.
// Example output:
// plaintext
// Copy code
// Hamming Code: 1 0 0 1 0 1 1
...
// 1
// Explanation:
// The program checks for parity errors in the received Hamming code.
// If an error is detected, it identifies the bit position and corrects it.
// Example output:
// plaintext
// Copy code
// Error detected at position: 4
// Corrected Hamming Code: 1 0 0 1 0 1 1
